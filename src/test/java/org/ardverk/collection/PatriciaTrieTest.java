...
public class PatriciaTrieTest {
    ...
    public void testSimple() {
        MCritBitTree<Integer, String> intTrie =
            new MCritBitTree<Integer, String>(IntegerKeyAnalyzer.INSTANCE);
    ...
    public void testCeilingEntry() {
        MCritBitTree<Character, String> charTrie =
            new MCritBitTree<Character, String>(CharacterKeyAnalyzer.INSTANCE);
        charTrie.put('c', "c");
        charTrie.put('p', "p");
        charTrie.put('l', "l");
        charTrie.put('t', "t");
...
//        cursor.finished();
    ...
    public void testTraverseCursorRemove() {
        MCritBitTree<Character, String> charTrie = new MCritBitTree<Character, String>(CharacterKeyAnalyzer.INSTANCE);
        charTrie.put('c', "c");
        charTrie.put('p', "p");
        charTrie.put('l', "l");
        charTrie.put('t', "t");
...
//        cursor.finished();
    ...
    public void testHamlet() throws Exception {
        ...
        MCritBitTree<String, String> trie = new MCritBitTree<String, String>(StringKeyAnalyzer.INSTANCE);

        InputStream in = getClass().getResourceAsStream("hamlet.txt");
        BufferedReader reader = new BufferedReader(new InputStreamReader(in));

        String read = null;
        String controlCollision = null;
        String testingCollision = null;
        while( (read = reader.readLine()) != null) {
            StringTokenizer st = new StringTokenizer(read);
            while(st.hasMoreTokens()) {
                String token = st.nextToken();
                original.add(token);
                controlCollision = sortedControl.put(token, token);
                testingCollision = trie.put(token, token);
                TestCase.assertEquals(controlCollision, testingCollision);
            }
        }
...
//        }
    ...
    public void testPrefixedBy() {
        MCritBitTree<String, String> trie
